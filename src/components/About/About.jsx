        ...
        <div className="table">
          ...
          <div className="table__bot">
            <div className="table__text">
              <h2 className="table__text_title">Выставка</h2>
              <p className="table__bot_title">{t("exhibition title1")}</p>
              <p className="table__bot_text">{t("exhibition text1")}</p>
            </div>
            <span className="table__line_bot"></span>
            <div className="table__text">
              <h2 className="table__text_title">Выставка</h2>
              <p className="table__bot_title">{t("exhibition title2")}</p>
              <p className="table__bot_text">{t("exhibition text2")}</p>
            </div>
          </div>
          <Link href="#" className="table__title table__title_mobile">
            <p> {t("buy art")}</p>
            <img className="mk__arrow table__arrow" alt="arrow" src={arrow} />
          </Link>
        </div>
